...
export default function Page() {
  return (
    <main className='flex w-full flex-col items-center px-[2rem]'>
      ...
      <MovingChips />
      <MarketingCTAButton
        label={G_TAG.AI_MOOD_CURATION_CLICK.label}
        gtag={G_TAG.AI_MOOD_CURATION_CLICK.gtag}
        route={G_TAG.AI_MOOD_CURATION_CLICK.route}
      />
      <div className='mt-[8rem] flex flex-col gap-[3.8rem]'>
        <div className='flex flex-col gap-[0.7rem] text-center'>
          <h2 className='text-black-1 title-23-eb'>
            원하는 조건으로
            <br />
      ...
      <MarketingCTAButton
        label={G_TAG.MOOD_SNAP_PRODUCT_CLICK.label}
        gtag={G_TAG.MOOD_SNAP_PRODUCT_CLICK.gtag}
        route={G_TAG.MOOD_SNAP_PRODUCT_CLICK.route}
      />
      <div className='mt-[8rem] flex flex-col gap-[3.8rem]'>
        <div className='flex flex-col gap-[0.7rem] text-center'>
          <h2 className='text-black-1 title-23-eb'>
        ...
        <Image src={ImageClientReserve} alt='클라이언트 스냅 예약 정보 이미지' />
      </div>
      <MarketingCTAButton
        label={G_TAG.MOOD_SNAP_RESERVE_CLICK.label}
        gtag={G_TAG.MOOD_SNAP_RESERVE_CLICK.gtag}
        route={G_TAG.MOOD_SNAP_RESERVE_CLICK.route}
      />
    </main>
  );
}
